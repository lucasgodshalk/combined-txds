...
class PhaseCapacitor(Bus):
    ...
    def collect_Y_stamps(self, state, v_estimate):
        ...
        global_vars.add_linear_Y_stamp(state, f_r, f_r, 1/z)
        global_vars.add_linear_Y_stamp(state, f_i, f_i, 1/z)
        # r,x = z.real, z.imag
        ...
        # global_vars.add_linear_Y_stamp(state, f_r, f_i, -b)
        # global_vars.add_linear_Y_stamp(state, f_i, f_r, b)
