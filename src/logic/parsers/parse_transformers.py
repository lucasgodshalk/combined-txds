...
from models.positiveseq.transformer import Transformer
...
class TwoWindingXfmrs:
    ...
    def createXfmrObject(self, all_bus_key: typing.Dict[int, Bus]):
        if self.mStatus:
            new_xfmr = Transformer(all_bus_key[int(self.mPrimaryBus)], all_bus_key[int(self.mSecondaryBus)], self.mRLoss,
...
class ThreeWindingXfmrs(object):
    ...
    def createXfmrObject(self, all_bus_key: typing.Dict[int, Bus]):
        ...
        if self.mWindingStatus[0]:
            ...
            new_3xfmr1 = Transformer(all_bus_key[int(self.mPrimaryBus[0])], all_bus_key[int(self.mSecondaryBus[0])], self.mR1,
        ...
        if self.mWindingStatus[1]:
            ...
            new_3xfmr2 = Transformer(all_bus_key[int(self.mPrimaryBus[1])], all_bus_key[int(self.mSecondaryBus[1])], self.mR2,
        ...
        if self.mWindingStatus[2]:
            ...
            new_3xfmr3 = Transformer(all_bus_key[int(self.mPrimaryBus[2])], all_bus_key[int(self.mSecondaryBus[2])], self.mR3,
